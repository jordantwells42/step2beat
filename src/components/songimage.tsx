...
export default function SongImage({
  ...
  return (
    <div className="flex aspect-square h-full flex-row items-center justify-center rounded-lg">
      ...
      <img className="object-contain h-full aspect-square" alt={songName} src={imgUrl}></img>
    </div>
  );
}
