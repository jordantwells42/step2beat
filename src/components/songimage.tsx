...
export default function SongImage({
  ...
  return (
    <div className="flex aspect-square h-full flex-row items-center justify-center rounded-l-lg">
      <a target="_blank" rel="noreferrer" className="flex-col rounded-l-xl backdrop-brightness-125 w-5 h-full hover:text-aluminium-600 text-center justify-center items-center" href={spotifyUrl}>
